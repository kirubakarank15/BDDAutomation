Feature: 
  ...
  Scenario Outline: To check whether subscriptions are populated properly in Customer,cat and Dealer subscription dropdown for the device Type PLE640.
    ...
    Examples: 
      ...
      | PLE641      | NULL | VISION_LINK                 | Cat Basic - Hourly,Cat Basic - 10 Minutes,Cat Essentials - Hourly,Cat Essentials - 10 Minutes                            |                                                                                                                          |                                                                                                                          |
      | PLE641      | NULL | MY.CAT.COM                  | Cat Daily                                                                                                                |                                                                                                                          |                                                                                                                          |
      | PLE641      | NULL | EQUIPMENT_TRACKER           | Cat Daily                                                                                                                |                                                                                                                          |                                                                                                                          |
      | PLE641      | NULL | PRODUCT LINK WEB GENERATION | Base,Comp,Custom                                                                                                         | Base,Comp,Custom                                                                                                         | Base,Comp,Custom                                                                                                         |
  ...
  Scenario Outline: To
    ...
    Examples: 
      ...
      | PLE641      | NULL | VISION_LINK      | Cat Basic - Hourly          |                           |                        | Advanced Productivity,Onboard Analytics                                              |
      | PLE641      | NULL | VISION_LINK      | Cat Basic - 10 Minutes      |                           |                        | Advanced Productivity,Onboard Analytics                                              |
      | PLE641      | NULL | VISION_LINK      | Cat Essentials - Hourly     |                           |                        | Advanced Productivity,VisionLink Load and Cycle Project Monitoring,Onboard Analytics |
      | PLE641      | NULL | VISION_LINK      | Cat Essentials - 10 Minutes |                           |                        | Advanced Productivity,VisionLink Load and Cycle Project Monitoring,Onboard Analytics |
