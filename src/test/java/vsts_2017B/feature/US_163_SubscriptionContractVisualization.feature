...
Feature: Subscription Contract Visualization - Contract Period and Automatic Renewal Options
  ...
  #other dealercodes these options are not avail - added
  #Dealercode list
  ...
  Scenario Outline: To Verify the UI position and values of ContractPeriod and AutoRenew Option in CAT login #failed bug id 883
    ...
    Examples: 
      | Dealercode | Values      | Services        | Cat Level Subscription | Dealer Level Subscription | Customer Level Subscription | Additional Services |
  ...
  Scenario Outline: To Verify the AutoRenew option is not enabled when No Contract period is selected in CAT Login
    ...
    Examples: 
      | Dealercode | Services        | Cat Level Subscription | Dealer Level Subscription | Customer Subscription  | Additional Services |
  ...
  Scenario Outline: To Verify the AutoRenew functionality when the checkbox is unchecked in CAT login #blocked
    ...
    Examples: 
      | Dealercode | Services        | Cat Level Subscription | Dealer Level Subscription | Customer Level Subscription | Additional Services | Value  |
  ...
  Scenario Outline: To Vefiry Contract Period and Auto renew option are not displayed when only CAT level subscription is selected
    ...
    Examples: 
      | Services         | Cat Level Subscription | Additional Services |
  ...
  Scenario Outline: To Verify Contract Period and Autorenew options are not displayed for unsupported dealercodes
    ...
    Examples: 
      | DealerCode | Services         | Cat Level Subscription | Dealer Level Subscription | Customer Level Subscription | Additional Services                          |
      | TD99       | Product Link web | Aide(EC4-14)           | Aide(EC4-14)              | Aide(EC4-14)                | VisionLink Load and Cycle Project Monitoring |
      | TD00       |                  |                        |                           |                             |                                              |
      | TD67       |                  |                        |                           |                             |                                              |
  ...
  Scenario Outline: To Verify the UI position and values of ContractPeriod and AutoRenew Option in Dealer login
    ...
    Examples: 
      | Dealercode | Values      | Services        | Dealer Level Subscription | Customer Level Subscription | Additional Services |
  ...
  Scenario Outline: To Verify Contract Period and Autorenew options are not displayed for unsupported dealercodes
    ...
    Examples: 
      | DealerCode | Services         | Dealer Level Subscription | Customer Level Subscription | Additional Services                          |
      | TD99       | Product Link web | Aide(EC4-14)              | Aide(EC4-14)                | VisionLink Load and Cycle Project Monitoring |
      | TD00       |                  |                           |                             |                                              |
      | TD67       |                  |                           |                             |                                              |
