...
public class CommonMethods_DeleteSubscriptions 
{
	...
	// Following function will build a URL
		...
		public static APIReponse apiexecutuion(String requestBody,String contentType,String acceptType,String requestType, String id)
				throws FileNotFoundException, NullPointerException, IOException, JSONException {

			StringEntity input = null;
		   
			CommonMethods_DeleteSubscriptions reusemethods = new CommonMethods_DeleteSubscriptions();
			String FetchOath = reusemethods.GetOAuth(); // to get the OAuth from
														// common_methods class
			URI uri = reusemethods.buildingurl(id);
