...
public class DeleteCustInheritedSubscriptions 
{
	...
	public static void DelCustInheritedsubscriptions(String cancelReason,String level) throws IOException,DSPAutomationException
	{
		...
		{
			id = CustInheritedSubscriptions.custParentId;
		}
		else if(level.equals("CAT"))
		{
			 id = CustInheritedSubscriptions.CATId;
				
		}
		else if(level.equals("Dealer"))
		{
			id= CustInheritedSubscriptions.DealerId;
